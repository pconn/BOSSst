...
Control=list(iter=1100000,burnin=600000,thin=250,n.adapt=500000,predict=TRUE,MH.N=rep(0.2,n_species),adapt=TRUE,fix.tau.epsilon=rep(TRUE,4),species.optim=TRUE,update.sp=TRUE,est.alpha=F,n.files=10,fname="./output/Bering2012all_test")        
Control$fix.tau.linear=TRUE
Control$Tau.eps.end=c(20,20,20,20)
Control$save.file="BOSS2013_mcmc_workspace.RData"
