...
TmbFile = "C:/Users/paul.conn/git/BOSSst/BOSSst/src/BossTMB_fixObs"
...
Params = list("log_N"=log(c(200000,80000,100000,100000)),"Beta"=Beta_init,"logtau_eta"=rep(0,n_species), "logkappa_eta"=rep(-2,n_species),"logit_rho"=rep(2,n_species),"Etainput_st"=Etainput_st,"thin_beta_day"=rep(0,2*n_species))
