...
source('./BOSSst/R/sim_data_generic.R')
...
Control=list(iter=152000,burnin=2000,thin=200,n.adapt=2000,predict=TRUE,MH.N=rep(0.2,n.species),adapt=TRUE,fix.tau.epsilon=FALSE,species.optim=TRUE)        
...
save(MCMC,file="mcmc_generic_REonly_nosp.Rdata")
#Obs.data
...
Cur.G2=matrix(apply(MCMC$Post$G[isp,400:750,],2,'median'),S,t.steps)
for(i in 1:t.steps){
